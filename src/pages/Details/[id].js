...
const Details = () => {
  ...
  const currentData = vacationData.filter((item) => item.id == matchingId);
            ...
            <Box className={styles.descriptionContainer}>
              ...
              <Box className={styles.descriptionInnerContainer}>
                <Box className={styles.descriptionData}>
                  ...
                  <Box sx={{ mt: "10px" }}>
                    <p style={{ fontSize: "12px" }}>Experimental Reviews...</p>
                    <Box sx={{ display: "flex" }}>
                      <Box
                        sx={{
                          display: "flex",
                  ...
                  <Box sx={{ mt: "20px", flexDirection: "column" }}>
                    ...
                    <Box>
                      ...
                      <p style={{ marginTop: "5px" }}>
                        ...
                        consistently earn great reviews from travellers and are
                        ranked within the top 10% of properties on Gateways.
                      </p>
                    </Box>
                  </Box>
                </Box>
